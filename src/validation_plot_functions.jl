...
function mpb_validation_plot()
    ...
    # export plots
    run(`mkdir -p validation-figures`)
    plot(p1)
    savefig(p1,"validation-figures/TEMPMPB2D_validation.png")
    plot(p2)
    savefig(p2,"validation-figures/TEMPMPB2D_time_accuracy.png")
    plot(p3)
    savefig(p3,"validation-figures/TEMPMPB2D_cond.png")
